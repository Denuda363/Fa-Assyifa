        ...
        <header className="bg-[#11141b] border-b border-slate-800 md:hidden flex flex-col sticky top-0 z-10">
          <div className="h-16 flex items-center justify-between px-4">
             ...
             <select 
               ...
               className="block w-40 pl-3 pr-8 py-2 text-sm bg-[#0a0c10] border-slate-700 text-white focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 rounded-lg border appearance-none"
             >
               {navItems.map(item => (
